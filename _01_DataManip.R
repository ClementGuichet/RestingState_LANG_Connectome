...
Network_overlap_InLang <- read_excel("D:/Analyses/_Power264_to_CABNP/Network_overlap_InLang.xlsx",
  sheet = "Liberal"
) %>%
...
meta_data_1 <- read_excel("D:/Analyses/0_Données fMRI/Recap_databases_HC_RS.xlsx") %>%
